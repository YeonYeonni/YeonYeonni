...
### [Publication]
#### Domestic
- [모션스피어 기반의 속도 조절 가능한 동작 저작 시스템(Velocity Adjustable Motion Authoring System based on Motion sphere)](https://www.dbpia.co.kr/Journal/articleDetail?nodeId=NODE12041787), (KSC 2024, 이정연 (중앙대학교),김정준 (중앙대학교), 채영호 (중앙대학교))
- [PromoEdit 비전문적인 모캡 데이터 편집을 통한 전문적인 모션 생성] (KCC 2025, 김정준 (중앙대학교), 이정연 (중앙대학교), 채영호 (중앙대학교))
#### International
